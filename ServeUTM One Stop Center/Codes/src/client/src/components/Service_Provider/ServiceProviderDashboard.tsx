import useGetProviderStats from "@/hooks/Service_Provider/useGetProviderStats";
      ...
      <div className="container space-y-4 my-4">
        <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {isLoading ? <Spinner /> : `RM ${data?.total_revenue}`}
              </div>
            </CardContent>
          </Card>
          <Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {isLoading ? <Spinner /> : `- ${data?.canceled}`}
              </div>
            </CardContent>
          </Card>
        </section>
