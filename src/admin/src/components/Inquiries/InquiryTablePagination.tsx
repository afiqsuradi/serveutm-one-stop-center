import { InquiryFilterType } from "../../hooks/Inquiries/useInquiries";
...
const InquiryTablePagination = ({ count, setFilters, limit, page }: Props) => {
...
export default InquiryTablePagination;
